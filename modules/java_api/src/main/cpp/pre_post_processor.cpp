...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_PrePostProcessor_GetPrePostProcessor(JNIEnv* env,
                                                                                     jobject,
                                                                                     jlong modelAddr) {
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_PrePostProcessor_Input(JNIEnv* env, jobject, jlong addr) {
    JNI_METHOD("Input", preprocess::PrePostProcessor* processor = (preprocess::PrePostProcessor*)addr;
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_PrePostProcessor_Output(JNIEnv* env, jobject, jlong addr) {
    JNI_METHOD("Output", preprocess::PrePostProcessor* processor = (preprocess::PrePostProcessor*)addr;
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_PrePostProcessor_Build(JNIEnv* env, jobject, jlong addr) {
    JNI_METHOD("Build", preprocess::PrePostProcessor* processor = (preprocess::PrePostProcessor*)addr;
