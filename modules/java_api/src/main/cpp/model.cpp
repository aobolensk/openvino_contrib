...
JNIEXPORT jstring JNICALL Java_org_intel_openvino_Model_getName(JNIEnv* env, jobject, jlong addr) {
    JNI_METHOD("getName", std::shared_ptr<Model>* model = reinterpret_cast<std::shared_ptr<Model>*>(addr);
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_Model_getBatch(JNIEnv* env, jobject, jlong addr) {
    JNI_METHOD("getBatch", std::shared_ptr<Model>* model = reinterpret_cast<std::shared_ptr<Model>*>(addr);
...
JNIEXPORT jobject JNICALL Java_org_intel_openvino_Model_getOutputs(JNIEnv* env, jobject, jlong modelAddr) {
    JNI_METHOD(
        "getOutputs", std::shared_ptr<Model>* model = reinterpret_cast<std::shared_ptr<Model>*>(modelAddr);
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_Model_getOutput(JNIEnv* env, jobject, jlong modelAddr) {
    JNI_METHOD("getOutput", std::shared_ptr<Model>* model = reinterpret_cast<std::shared_ptr<Model>*>(modelAddr);
...
JNIEXPORT void JNICALL Java_org_intel_openvino_Model_Reshape(JNIEnv* env, jobject, jlong addr, jintArray shape) {
    JNI_METHOD("Reshape", std::shared_ptr<Model>* model = reinterpret_cast<std::shared_ptr<Model>*>(addr);

               PartialShape partialShape;
               for (auto& value
                    : jintArrayToVector(env, shape)) partialShape.push_back(value);
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_Model_getInput(JNIEnv* env, jobject, jlong modelAddr) {
    JNI_METHOD("getInput", std::shared_ptr<Model>* model = reinterpret_cast<std::shared_ptr<Model>*>(modelAddr);
