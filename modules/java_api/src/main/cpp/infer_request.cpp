...
JNIEXPORT void JNICALL Java_org_intel_openvino_InferRequest_Infer(JNIEnv* env, jobject obj, jlong addr) {
    JNI_METHOD("Infer", InferRequest* infer_request = (InferRequest*)addr; infer_request->infer();)
}

JNIEXPORT void JNICALL Java_org_intel_openvino_InferRequest_StartAsync(JNIEnv* env, jobject obj, jlong addr) {
    JNI_METHOD("StartAsync", InferRequest* infer_request = (InferRequest*)addr; infer_request->start_async();)
}

JNIEXPORT void JNICALL Java_org_intel_openvino_InferRequest_Wait(JNIEnv* env, jobject obj, jlong addr) {
    JNI_METHOD("Wait", InferRequest* infer_request = (InferRequest*)addr; infer_request->wait();)
}

JNIEXPORT void JNICALL Java_org_intel_openvino_InferRequest_SetInputTensor(JNIEnv* env,
                                                                           jobject,
                                                                           jlong addr,
                                                                           jlong tensorAddr) {
    JNI_METHOD("SetInputTensor", InferRequest* infer_request = (InferRequest*)addr;
               Tensor* input_tensor = (Tensor*)tensorAddr;
               infer_request->set_input_tensor(*input_tensor);)
}

JNIEXPORT void JNICALL Java_org_intel_openvino_InferRequest_SetOutputTensor(JNIEnv* env,
                                                                            jobject,
                                                                            jlong addr,
                                                                            jlong tensorAddr) {
    JNI_METHOD("SetOutputTensor", InferRequest* infer_request = (InferRequest*)addr;
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_InferRequest_GetOutputTensor(JNIEnv* env, jobject obj, jlong addr) {
    JNI_METHOD("GetOutputTensor", InferRequest* infer_request = (InferRequest*)addr;
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_InferRequest_GetTensor(JNIEnv* env,
                                                                       jobject obj,
                                                                       jlong addr,
                                                                       jstring tensorName) {
    JNI_METHOD("GetTensor", InferRequest* infer_request = (InferRequest*)addr; Tensor* output_tensor = new Tensor();
...
JNIEXPORT void JNICALL Java_org_intel_openvino_InferRequest_SetTensor(JNIEnv* env,
                                                                      jobject obj,
                                                                      jlong addr,
                                                                      jstring tensorName,
                                                                      jlong tensorAddr) {
    JNI_METHOD("SetTensor", InferRequest* infer_request = (InferRequest*)addr;
