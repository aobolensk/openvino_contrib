...
JNIEXPORT jstring JNICALL Java_org_intel_openvino_Any_asString(JNIEnv* env, jobject obj, jlong addr) {
    JNI_METHOD("asString", Any* obj = (Any*)addr; std::string n_string = obj->as<std::string>();
